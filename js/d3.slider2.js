d3.slider = function module() {
    ...
    var div, min = 0,
        max = 50,
        svg, svgGroup, value, classPrefix, axis, height = 20,
        rect, rectHeight = 10,
        tickSize = 6,
        margin = {
            top: 5,
    ...
    function slider(selection) {
        selection.each(function() {
            ...
            dragger.append("circle").attr("class", "dragger-outer").attr("r", 8).attr("transform", function(d) {
                return "translate(0,5)";
            });
            dragger.append("circle").attr("class", "dragger-inner").attr("r", 4).attr("transform", function(d) {
                return "translate(0,5)";
            });
